    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Profile Image */}
          <div
            className={`relative reveal-element ${inView ? "revealed" : ""}`}
            ref={ref}
          >
            ...
            <div
              className="absolute -bottom-6 -left-6 w-20 h-20 bg-purple-500/20 rounded-full floating-element"
          ...
          {/* About Content */}
          <div
            className={`space-y-8 reveal-element ${inView ? "revealed" : ""}`}
          >
            <div>
              ...
              >
                <p>
                  I'm a passionate frontend developer who believes great user
                  experiences are built on the intersection of beautiful design
                  and clean, performant code.
                </p>
                <p>
                  My approach combines modern development practices with an eye
                  for detail that ensures every pixel serves a purpose. I
                  specialize in React ecosystems, TypeScript, and creating
